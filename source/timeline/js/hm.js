(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "1fd3af480ea526e0aff7b82398738b9d",
        dm: ["sfantree.com"],
    ...
    mt.h.J = function(a, b) {
        ...
        for (; a.parentNode != t; ) {
            ...
            if ((l = "" !== a.id) && b) {
                ...
                g.push(l)),
                d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + m + "]" : ""));
            a = a.parentNode
        }
        g.push(d.join(">"));
        return g
        ...
        (function() {
            if (!d)
                ...
                "complete" === document.readyState)
                    ...
                    document.addEventListener("DOMContentLoaded", f, u),
    ...
    mt.localStorage.set = function(a, b, d) {
        ...
        try {
            ...
            window.localStorage.setItem(a, b)) : mt.localStorage.C() && (mt.localStorage.g.expires = g.toUTCString(),
            mt.localStorage.g.load(document.location.hostname),
            mt.localStorage.g.setAttribute(a, b),
    ...
    (function() {
        var a = {
            ...
            w: function(a, d) {
                this.p[a] = this.p[a] || [];
                for (var g = this.p[a].length, f = 0; f < g; f++)
                    this.p[a][f](d)
            }
        };
        return h.G = a
    ...
    (function() {
        ...
        function g(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                k = "focus" == a.type || "focusin" == a.type ? s : u,
                b()
        }
        var f = mt.event, m = h.G, l = s, e = s, n = s, k = s, w = +new Date, p = w, q = 0, v = s, x = d("visibilityState"), z = d("hidden"), y;
        b();
        (function() {
          ...
          , e = {
            ...
            _trackPageview: function(a) {
                if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                    ...
                    e.W || (h.b.a.su = document.location.href);
                    h.b.k();
                    h.b.a.u = d;
                    h.b.a.su = b
                }
            ...
            _trackEvent: function(a) {
                ...
                h.b.a.st = 4,
                h.b.a.et = 4,
                h.b.a.ep = d.j(a[1]) + "*" + d.j(a[2]) + (a[3] ? "*" + d.j(a[3]) : "") + (a[4] ? "*" + d.j(a[4]) : ""),
                h.b.k())
            },
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < f && 4 > f) {
                        e.B++;
                        for (var p = (h.b.a.cv || "*").split("!"), q = p.length; q < b - 1; q++)
                            p.push("*");
            ...
            _setReferrerOverride: function(a) {
                1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? f.protocol + "//" + window.location.host + a[1] : a[1],
                e.W = s)
            },
            ...
            _trackRTEvent: function(a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= l)
                        ...
                        for (var l = Math.ceil(l / 900), p = "block|" + Math.round(Math.random() * f.N).toString(16) + "|" + l + "|", q = [], v = 0; v < l; v++)
                            q.push(v),
                            q.push(a.substring(900 * v, 900 * v + 900)),
                            k.call(this, p + q.join("|")),
                            q = []
                }
            },
        ...
        a.prototype = {
            ...
            T: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.X(document.location.href, d))
                        return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            sa: function() {
                ...
                var a = u;
                this.z(document.referrer) && this.z(document.location.href) ? a = s : (a = b.U(document.referrer),
            ...
            Ia: function() {
                ...
                if (0 === c.nv && this.z(document.location.href) && ("" === document.referrer || this.z(document.referrer)))
                    a = 0,
                    b = 4;
                this.a.nv = a;
                this.a.st = b;
            ...
            Ja: function() {
                ...
                this.a.cw = b.f(a, k.wa) || b.f(a, k.Pa) || "";
            ...
            k: function(a) {
                var b = this;
                b.a.rnd = Math.round(Math.random() * k.N);
                w.w("stag-b");
                var e = k.M + "//" + k.Y + "?" + b.Ha();
                w.w("stag-d");
                b.ca(e);
            ...
            fa: function() {
                ...
                a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.N),
            ...
            P: function(a) {
                ...
                (b = b.replace(a, "").replace(/,$/, "")) ? n.set("Hm_unsent_" + c.id, b) : n.remove("Hm_unsent_" + c.id))
            },
            Ga: function() {
                var a = this
            ...
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var e = function() {
                    ...
                    var n = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || []
                      , v = t;
                    b = t;
                    if ("www.baidu.com" === n[2] || "m.baidu.com" === n[2])
                        v = d.f(a, "qid"),
                        b = d.f(a, "click_t");
                    a = v;
                    e.qid = a != t ? a : "";
                    b != t ? (e.bdDom = l ? l - b : 0,
                    e.bdRun = f - b,
                    e.bdDef = m("navigation").start - b) : (e.bdDom = 0,
                    e.bdRun = 0,
                    e.bdDef = 0);
                    h.b.a.et = 87;
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.Ca || 7 < a.Aa) && c.cvcc)) {
            var f, m, l, e, n = function(a) {
                ...
                for (var d in a)
                    if (a.hasOwnProperty(d) && b.call(a, d, a[d]) === u)
                        return u
            }, w = function(a, d) {
                var e = {};
                e.n = f;
            ...
            if (c.med)
                ...
                e = {
                    click: function() {
                        for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, e, f = 0, g = b.length; f < g; f++)
                            d = b[f],
                            e = d.getAttribute("onclick"),
                            d = d.getAttribute("href"),
                            (l.test(e) || l.test(d)) && a.push(b[f]);
                        return a
                    }
                };
            else if (c.cvcc) {
                ...
                e = {
                    click: function() {
                        for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, e, f, g = 0, k = b.length; g < k; g++)
                            d = b[g],
                            l !== r ? (e = d.getAttribute("onclick"),
                            f = d.getAttribute("href"),
                            p ? (d = d.getAttribute("id"),
                            (l.test(e) || l.test(f) || p.test(d)) && a.push(b[g])) : (l.test(e) || l.test(f)) && a.push(b[g])) : p !== r && (d = d.getAttribute("id"),
                            p.test(d) && a.push(b[g]));
                        return a
                    }
                }
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var f = {
                ba: function() {
                    for (var b = c.cvcf.length, g, e = 0; e < b; e++)
                        (g = a.na(decodeURIComponent(c.cvcf[e]))) && d.c(g, "click", f.ia())
                },
                ia: function() {
                    return function() {
                        h.b.a.et = 86;
